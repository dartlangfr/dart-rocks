...
$$._AttributeClassSet = {"": "CssClassSetImpl;_liblib2$_element",
  readClasses$0: function() {
    ...
    classname = $.get$attributes$x(this._liblib2$_element)._element.getAttribute("class");
    s = $.LinkedHashSet$();
    if (classname == null)
      return s;
...
$$.main_closure = {"": "Closure;slides_0",
  call$1: function(e) {
    ...
    switch ($event.get$keyCode($event)) {
      ...
      case 32:
        t1 = this.slides_0;
        t2 = t1._currentPosition;
        if ($.$lt$n(t2, $.$sub$n(t1._slidesNumbers, 1)))
          t1.goPosition$2(t2, 1);
        break;
      case 37:
        t1 = this.slides_0;
        t2 = t1._currentPosition;
      ...
      case 96:
        t1 = this.slides_0;
        t2 = $.get$classes$x(t1._help).readClasses$0();
        t2 = t2.contains$1(t2, "invisible");
        t1 = t1._help;
        if (t2 === true) {
          t1 = $.get$classes$x(t1);
...
$$.Slides = {"": "Object;_currentToken,_currentPosition<,_slidesNumbers<,_slides,_counterBackground,_counterButton,_help<",
  start$1: function(_, hash) {
    var t1;
    this._loadLocalStorageMessage$0();
    ...
    this._cssShadow$0();
    this._logoDemo$0();
    this._cssBackground$0();
    this._currentPosition = 0;
    this._slides = $.HtmlDocument_methods.queryAll$1(document, ".slide");
    t1 = this._slides;
    this._slidesNumbers = t1.get$length(t1);
    this._counterBackground = document.querySelector("#presentation-counter");
    this._counterButton = document.querySelector("#slide-no");
    $.set$display$x(document.querySelector(".slides").style, "block");
    t1 = this._slides;
    t1.forEach$1(t1, new $.Slides_start_closure());
    this._help = document.querySelector("#help");
    this._buildSummary$0();
    this._bindClick$0();
    t1 = $.getInterceptor$asx(hash);
    if (t1.get$isEmpty(hash) === true)
      this.goPosition$2(this._currentPosition, 0);
    else
      this.goId$1(t1.substring$1(hash, 1));
  },
  _bindClick$0: function() {
    var t1 = $.get$onClick$x(document.querySelector("#nav-next"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__bindClick_closure(this), t1._useCapture);
    t1 = $.get$onClick$x(document.querySelector("#nav-prev"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__bindClick_closure0(this), t1._useCapture);
    t1 = $.get$onClick$x(document.querySelector("#nav-help"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__bindClick_closure1(this), t1._useCapture);
    t1 = $.get$onClick$x(document.querySelector("#nav-toc"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__bindClick_closure2(this), t1._useCapture);
  },
  _buildSummary$0: function() {
    var transitionSlides, buffer, t1, t2;
    transitionSlides = $.HtmlDocument_methods.queryAll$1(document, ".transitionSlide");
    buffer = $.StringBuffer$("");
    transitionSlides.forEach$1(transitionSlides, new $.Slides__buildSummary_closure(buffer));
    t1 = document.querySelector("#toc-list");
    t2 = $.getInterceptor$x(t1);
    t2.set$innerHtml(t1, buffer._contents);
    t1 = t2.queryAll$1(t1, "li a");
    t1.forEach$1(t1, new $.Slides__buildSummary_closure0(this));
  },
  goPosition$2: function(position, direction) {
    var t1, t2, displayPosition, from, to, i, lastValueIndex;
    this._currentPosition = $.$add$ns(position, direction);
    t1 = this._slides;
    t2 = this._currentPosition;
    t1 = t1._nodeList;
    if (t2 >>> 0 !== t2 || t2 >= t1.length)
      throw $.ioore(t2);
    this._currentToken = $.get$id$x(t1[t2]);
    $.set$hash$x($.Window_methods.get$location(window), "#" + $.S(this._currentToken));
    displayPosition = $.toString$0($.$add$ns(this._currentPosition, 1));
    $.set$innerHtml$x(this._counterBackground, displayPosition);
    $.set$innerHtml$x(this._counterButton, displayPosition);
    from = $.max($.$sub$n(this._currentPosition, 3), 0);
    if (from !== (from | 0))
      return this.goPosition$2$bailout(1, direction, from);
    to = $.min($.$add$ns(this._currentPosition, 3), $.$sub$n(this._slidesNumbers, 1));
    if (typeof to !== "number")
      return this.goPosition$2$bailout(2, direction, from, to);
    for (i = from; i <= to; ++i) {
      t1 = this._currentPosition;
      if (typeof t1 !== "number")
        throw $.iae(t1);
      lastValueIndex = i - t1 + 3 + direction;
      if (lastValueIndex > 0 && lastValueIndex < 7) {
        t1 = this._slides._nodeList;
        if (i < 0 || i >= t1.length)
          throw $.ioore(i);
        t1 = $.get$classes$x(t1[i]);
        if (lastValueIndex >>> 0 !== lastValueIndex || lastValueIndex >= 7)
          throw $.ioore(lastValueIndex);
        t1.remove$1(t1, $.List_k6U[lastValueIndex]);
      }
      t1 = this._slides._nodeList;
      if (i < 0 || i >= t1.length)
        throw $.ioore(i);
      ...
      if (t2 >>> 0 !== t2 || t2 >= 7)
        throw $.ioore(t2);
      t1.add$1(t1, $.List_k6U[t2]);
    }
    this.goId$1(this._currentToken);
  },
  goPosition$2$bailout: function(state0, direction, from, to) {
    switch (state0) {
      case 0:
        this._currentPosition = $.$add$ns(position, direction);
        t1 = this._slides;
      ...
      case 1:
        ...
        to = $.min($.$add$ns(this._currentPosition, 3), $.$sub$n(this._slidesNumbers, 1));
      case 2:
        var t1, t2, displayPosition, i, lastValueIndex;
        state0 = 0;
        for (i = from; t1 = $.getInterceptor$n(i), t1.$le(i, to); ++i) {
          lastValueIndex = $.$add$ns($.$add$ns(t1.$sub(i, this._currentPosition), 3), direction);
          t1 = $.getInterceptor$n(lastValueIndex);
          if (t1.$gt(lastValueIndex, 0) && t1.$lt(lastValueIndex, 7)) {
            t1 = this._slides._nodeList;
  ...
  goId$1: function(id) {
    var t1, element, from, to, i, lastValueIndex;
    t1 = this._slides;
    element = t1.firstWhere$1(t1, new $.Slides_goId_closure(id));
    if (element != null) {
      t1 = this._slides;
      t1.indexOf$1(t1, element);
      from = $.max($.$sub$n(this._currentPosition, 3), 0);
      if (from !== (from | 0))
        return this.goId$1$bailout(1, from);
      to = $.min($.$add$ns(this._currentPosition, 3), $.$sub$n(this._slidesNumbers, 1));
      if (typeof to !== "number")
        return this.goId$1$bailout(2, from, to);
      for (i = from; i <= to; ++i) {
        t1 = this._currentPosition;
        if (typeof t1 !== "number")
          throw $.iae(t1);
        lastValueIndex = i - t1 + 3;
        if (lastValueIndex > 0 && lastValueIndex < 7) {
          t1 = this._slides._nodeList;
          if (i < 0 || i >= t1.length)
            throw $.ioore(i);
        ...
        if (i < 0 || i >= t1.length)
          throw $.ioore(i);
        t1 = $.get$classes$x(t1[i]);
        t1.add$1(t1, $.JSArray_methods.get$last($.List_k6U));
      }
    }
  },
  goId$1$bailout: function(state0, from, to) {
    switch (state0) {
      case 0:
        t1 = this._slides;
        element = t1.firstWhere$1(t1, new $.Slides_goId_closure(id));
      default:
        var t1, element, i, lastValueIndex;
        if (state0 === 2 || state0 === 1 || state0 === 0 && element != null)
          switch (state0) {
            case 0:
              t1 = this._slides;
              t1.indexOf$1(t1, element);
            ...
            case 2:
              state0 = 0;
              for (i = from; t1 = $.getInterceptor$n(i), t1.$le(i, to); ++i) {
                lastValueIndex = $.$add$ns(t1.$sub(i, this._currentPosition), 3);
                t1 = $.getInterceptor$n(lastValueIndex);
                if (t1.$gt(lastValueIndex, 0) && t1.$lt(lastValueIndex, 7)) {
                  t1 = this._slides._nodeList;
                  if (i >>> 0 !== i || i >= t1.length)
  ...
  _loadLocalStorageMessage$0: function() {
    var area, t1;
    area = document.querySelector("#ta");
    t1 = $.getInterceptor$x(area);
    if ($.get$isEmpty$asx(t1.get$value(area)))
      t1.set$value(area, window.localStorage.getItem("value"));
    t1 = $.get$onClick$x(document.querySelector("#save-ta"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__loadLocalStorageMessage_closure(area), t1._useCapture);
  },
  _textWrapping$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#tw-range"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__textWrapping_closure(), t1._useCapture);
  },
  _cssColumns$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#cco-range"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__cssColumns_closure(), t1._useCapture);
  },
  _cssStroke$0: function() {
    var input, t1;
    input = document.querySelector("#text-stroke");
    t1 = $.get$onChange$x(input);
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__cssStroke_closure(input), t1._useCapture);
  },
  _cssOpacity$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#opacity-color"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__cssOpacity_closure(this), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#opacity-background"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeCssOpacity(), t1._useCapture);
  },
  _changeCssOpacity$1: function(e) {
    var textOpacity, backgroundOpacity, el;
    textOpacity = $.$div$n($.get$valueAsNumber$x(document.querySelector("#opacity-color")), 100);
    backgroundOpacity = $.$div$n($.get$valueAsNumber$x(document.querySelector("#opacity-background")), 100);
    el = document.querySelector("#opacity-example");
    $.set$color$x(el.style, "rgba(255, 0, 0, " + $.S(textOpacity) + ")");
    $.set$background$x(el.style, "rgba(0, 0, 255, " + $.S(backgroundOpacity) + ")");
    document.querySelector("#opacity-color-value").textContent = $.JSNumber_methods.toString$0(textOpacity);
    document.querySelector("#opacity-background-value").textContent = $.JSNumber_methods.toString$0(backgroundOpacity);
  },
  get$_changeCssOpacity: function() {
    return new $.BoundClosure$1(this, "_changeCssOpacity$1");
  },
  _cssColor$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#hsl-h"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeHSL(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#hsl-s"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeHSL(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#hsl-l"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeHSL(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#hsl-a"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeHSL(), t1._useCapture);
  },
  _changeHSL$1: function(e) {
    var h, s, l, a;
    h = $.JSNumber_methods.toInt$0($.$mul$n($.get$valueAsNumber$x(document.querySelector("#hsl-h")), 1));
    s = $.JSNumber_methods.toInt$0($.$mul$n($.get$valueAsNumber$x(document.querySelector("#hsl-s")), 1));
    l = $.JSNumber_methods.toInt$0($.$mul$n($.get$valueAsNumber$x(document.querySelector("#hsl-l")), 1));
    a = $.$div$n($.get$valueAsNumber$x(document.querySelector("#hsl-a")), 100);
    $.set$color$x(document.querySelector("#hsl-example").style, "hsla(" + $.S(h) + ", " + $.S(s) + "%, " + $.S(l) + "%, " + $.S(a) + ")");
    document.querySelector("#hsl-h-value").textContent = $.S(h);
    document.querySelector("#hsl-s-value").textContent = $.S(s) + "%,";
    document.querySelector("#hsl-l-value").textContent = $.S(l) + "%,";
    document.querySelector("#hsl-a-value").textContent = $.S(a) + ");";
  },
  get$_changeHSL: function() {
    return new $.BoundClosure$1(this, "_changeHSL$1");
  },
  _roundedCorners$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#face-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#lefteye-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#righteye-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#base_white-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#mouth-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#nose-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#leftblackeye-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#rightblackeye-rounded-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_handleCorner(), t1._useCapture);
  },
  _handleCorner$1: function(e) {
    var t1, el, element, t2, borderVal;
    for (t1 = $.JSArray_methods.get$iterator(["face", "lefteye", "righteye", "base_white", "mouth", "nose", "leftblackeye", "rightblackeye"]); t1.moveNext$0();) {
      el = t1.get$current();
      element = $.S(el) + "-rounded-border";
      t2 = "#" + element;
      borderVal = $.get$value$x(document.querySelector(t2));
      t2 = "#" + element + "-value";
      document.querySelector(t2).textContent = borderVal;
      t2 = "#" + $.S(el);
      $.set$borderRadius$x(document.querySelector(t2).style, $.S(borderVal) + "px");
    }
  },
  get$_handleCorner: function() {
    return new $.BoundClosure$1(this, "_handleCorner$1");
  },
  _cssGradient$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#gradients-radial"));
    $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__cssGradient_closure(), t1._useCapture);
  },
  _cssShadow$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#shadows-text-x"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#shadows-text-y"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#shadows-text-size"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#shadows-box-x"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#shadows-box-y"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#shadows-box-size"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeShadow(), t1._useCapture);
  },
  _changeShadow$1: function(e) {
    var el, textXVal, textYVal, textSizeVal, boxXVal, boxYVal, boxSizeVal;
    el = document.querySelector("#shadow-example");
    textXVal = $.interceptedTypeCast(document.querySelector("#shadows-text-x"), "$isInputElement").value;
    textYVal = $.interceptedTypeCast(document.querySelector("#shadows-text-y"), "$isInputElement").value;
    textSizeVal = $.interceptedTypeCast(document.querySelector("#shadows-text-size"), "$isInputElement").value;
    document.querySelector("#shadows-text-x-value").textContent = textXVal;
    document.querySelector("#shadows-text-y-value").textContent = textYVal;
    document.querySelector("#shadows-text-size-value").textContent = textSizeVal;
    boxXVal = $.interceptedTypeCast(document.querySelector("#shadows-box-x"), "$isInputElement").value;
    boxYVal = $.interceptedTypeCast(document.querySelector("#shadows-box-y"), "$isInputElement").value;
    boxSizeVal = $.interceptedTypeCast(document.querySelector("#shadows-box-size"), "$isInputElement").value;
    document.querySelector("#shadows-box-x-value").textContent = boxXVal;
    document.querySelector("#shadows-box-y-value").textContent = boxYVal;
    document.querySelector("#shadows-box-size-value").textContent = boxSizeVal;
    $.set$textShadow$x(el.style, "rgba(64, 64, 64, 0.5)  " + $.S(textXVal) + "px " + $.S(textYVal) + "px " + $.S(textSizeVal) + "px");
    $.set$boxShadow$x(el.style, "rgba(0, 0, 128, 0.25) " + $.S(boxXVal) + "px " + $.S(boxYVal) + "px " + $.S(boxSizeVal) + "px");
  },
  get$_changeShadow: function() {
    return new $.BoundClosure$1(this, "_changeShadow$1");
  },
  _logoDemo$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#web20-shadow"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeWeb20(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#web20-gradient"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeWeb20(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#web20-border"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeWeb20(), t1._useCapture);
    t1 = $.get$onChange$x(document.querySelector("#web20-reflect"));
    $._EventStreamSubscription$(t1._target, t1._eventType, this.get$_changeWeb20(), t1._useCapture);
  },
  _changeWeb20$1: function(e) {
    var el, textShadowVal, gradientVal, borderVal, reflectVal;
    el = document.querySelector("#web20-google");
    textShadowVal = $.interceptedTypeCast(document.querySelector("#web20-shadow"), "$isInputElement").value;
    document.querySelector("#web20-shadow-value-1").textContent = textShadowVal;
    document.querySelector("#web20-shadow-value-2").textContent = textShadowVal;
    gradientVal = $.$div$n($.Primitives_parseInt($.interceptedTypeCast(document.querySelector("#web20-gradient"), "$isInputElement").value, null, null), 100);
    document.querySelector("#web20-gradient-value-1").textContent = $.JSNumber_methods.toString$0(gradientVal);
    document.querySelector("#web20-gradient-value-2").textContent = $.JSNumber_methods.toString$0(gradientVal);
    borderVal = $.interceptedTypeCast(document.querySelector("#web20-border"), "$isInputElement").value;
    document.querySelector("#web20-border-value").textContent = borderVal;
    reflectVal = $.$div$n($.Primitives_parseInt($.interceptedTypeCast(document.querySelector("#web20-reflect"), "$isInputElement").value, null, null), 100);
    document.querySelector("#web20-reflect-value").textContent = $.JSNumber_methods.toString$0(reflectVal);
    $.set$textShadow$x(el.style, "rgba(0, 0, 0, 0.5) 0 " + $.S(textShadowVal) + "px " + $.S(textShadowVal) + "px");
    $.set$background$x(el.style, "-webkit-gradient(linear, left top, left bottom, from(rgba(200, 200, 240, " + $.S(gradientVal) + ")), to(rgba(255, 255, 255, " + $.S(gradientVal) + ")))");
    $.set$borderRadius$x(el.style, $.S(borderVal) + "px");
    $.set$boxReflect$x(el.style, "below 10px -webkit-gradient(linear, left top, left bottom, from(transparent), to(rgba(255, 255, 255, " + $.S(reflectVal) + ")))");
  },
  get$_changeWeb20: function() {
    return new $.BoundClosure$1(this, "_changeWeb20$1");
  },
  _cssBackground$0: function() {
    var t1 = $.get$onChange$x(document.querySelector("#css-background-select"));
    return $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__cssBackground_closure(), t1._useCapture);
  }
};

$$.Slides_start_closure = {"": "Closure;",
  call$1: function(element) {
    var t1 = $.get$classes$x(element);
    return t1.add$1(t1, $.JSArray_methods.get$last($.List_k6U));
  }
};

$$.Slides__bindClick_closure = {"": "Closure;this_0",
  call$1: function(e) {
    var t1, t2;
    t1 = this.this_0;
    t2 = t1.get$_currentPosition();
    if ($.$lt$n(t2, $.$sub$n(t1.get$_slidesNumbers(), 1)))
      t1.goPosition$2(t2, 1);
    return;
  }
};

$$.Slides__bindClick_closure0 = {"": "Closure;this_1",
  call$1: function(e) {
    var t1, t2;
    t1 = this.this_1;
    t2 = t1.get$_currentPosition();
...
$$.Slides__bindClick_closure1 = {"": "Closure;this_2",
  call$1: function(e) {
    var t1, t2;
    t1 = this.this_2;
    t2 = $.get$classes$x(t1.get$_help()).readClasses$0();
    t2 = t2.contains$1(t2, "invisible");
    t1 = t1.get$_help();
    if (t2 === true) {
      t1 = $.get$classes$x(t1);
...
$$.Slides__bindClick_closure2 = {"": "Closure;this_3",
  call$1: function(e) {
    return this.this_3.goId$1("table-of-contents");
  }
};

$$.Slides__buildSummary_closure = {"": "Closure;buffer_0",
  call$1: function(e) {
    var t1, img, t2;
    t1 = $.getInterceptor$x(e);
    img = t1.query$1(e, "img");
    t2 = this.buffer_0;
    t1 = "<li><a data-hash=\"" + $.S(t1.get$id(e)) + "\">" + $.S($.get$innerHtml$x(t1.query$1(e, "h2"))) + "</a>";
    t2._contents = t2._contents + t1;
    t1 = "<img src=\"" + $.replaceAll$2$s($.get$src$x(img), "_64", "_32") + "\"></li>";
    t2._contents = t2._contents + t1;
  }
};

$$.Slides__buildSummary_closure0 = {"": "Closure;this_1",
  call$1: function(element) {
    var t1 = $.get$onClick$x(element);
    return $._EventStreamSubscription$(t1._target, t1._eventType, new $.Slides__buildSummary__closure(this.this_1, element), t1._useCapture);
  }
};

$$.Slides__buildSummary__closure = {"": "Closure;this_2,element_3",
  call$1: function($event) {
    return this.this_2.goId$1($.get$dataset$x(this.element_3).$$dom_attributes._element.getAttribute("data-hash"));
  }
};

$$.Slides_goId_closure = {"": "Closure;id_0",
  call$1: function(e) {
    return $.$eq($.get$id$x(e), this.id_0);
  }
};

$$.Slides__loadLocalStorageMessage_closure = {"": "Closure;area_0",
  call$1: function(e) {
    var now;
    $.$indexSet$ax(window.localStorage, "value", $.get$value$x(this.area_0));
    now = $.DateTime$_now();
    $.$indexSet$ax(window.localStorage, "timestamp", $.toString$0(now.millisecondsSinceEpoch));
  }
};

$$.Slides__textWrapping_closure = {"": "Closure;",
  call$1: function($event) {
    var value = $.get$valueAsNumber$x($.get$target$x($event));
    $.set$width$x(document.querySelector("#wrapping").style, $.S(value) + "%");
  }
};

$$.Slides__cssColumns_closure = {"": "Closure;",
  call$1: function($event) {
    var value = $.JSNumber_methods.toString$0($.toInt$0$n($.get$valueAsNumber$x($.get$target$x($event))));
    document.querySelector("#columns-no-value").textContent = value;
    $.set$columnCount$x(document.querySelector("#columns-no-example").style, value);
  }
};

$$.Slides__cssStroke_closure = {"": "Closure;input_0",
  call$1: function($event) {
    var width = $.$mul$n($.get$valueAsNumber$x(this.input_0), 0.25);
    $.set$textStrokeWidth$x(document.querySelector("#text-stroke-example").style, $.S(width) + "px");
    document.querySelector("#text-stroke-value").textContent = $.JSNumber_methods.toString$0(width);
  }
};

$$.Slides__cssOpacity_closure = {"": "Closure;this_0",
  call$1: function(e) {
    return this.this_0._changeCssOpacity$1(e);
  }
};

$$.Slides__cssGradient_closure = {"": "Closure;",
  call$1: function(e) {
    var size = $.interceptedTypeCast(document.querySelector("#gradients-radial"), "$isInputElement").value;
    $.set$background$x(document.querySelector("#gradients-radial-example").style, "-webkit-gradient(radial, 430 50, 0, 430 50, " + $.S(size) + ", from(red), to(#000))");
    document.querySelector("#gradients-radial-value").textContent = size;
  }
};

$$.Slides__cssBackground_closure = {"": "Closure;",
  call$1: function(e) {
    var t1, t2;
    t1 = document.querySelector("#background-textarea").style;
    t2 = $.interceptedTypeCast($.get$target$x(e), "$isSelectElement").value;
    $.set$backgroundSize$x(t1, t2);
    return t2;
  }
};
...
$$.AnchorElement = {"": "Element;hash%,target=",
  toString$0: function(receiver) {
...
$$.AreaElement = {"": "Element;hash=,target="};
...
$$.CssStyleDeclaration = {"": "Interceptor;length=",
  ...
  set$backgroundSize: function(receiver, value) {
    this.setProperty$3(receiver, "background-size", value, "");
  },
  set$borderRadius: function(receiver, value) {
    this.setProperty$3(receiver, "border-radius", value, "");
  },
  set$boxReflect: function(receiver, value) {
    this.setProperty$3(receiver, $.S($.Device_cssPrefix()) + "box-reflect", value, "");
  },
  ...
  set$columnCount: function(receiver, value) {
    this.setProperty$3(receiver, $.S($.Device_cssPrefix()) + "column-count", value, "");
  },
  set$display: function(receiver, value) {
    this.setProperty$3(receiver, "display", value, "");
  },
  set$textShadow: function(receiver, value) {
    this.setProperty$3(receiver, "text-shadow", value, "");
  },
  set$textStrokeWidth: function(receiver, value) {
    this.setProperty$3(receiver, $.S($.Device_cssPrefix()) + "text-stroke-width", value, "");
  },
...
$$.InputElement = {"": "Element;src=,value%,valueAsNumber=", $isInputElement: true, $asInputElement: null, $isElement: true, $asElement: null, $isNode: true, $asNode: null};
...
$$.SelectElement = {"": "Element;length=,value%", $isSelectElement: true, $asSelectElement: null};
...
$.main = function() {
  var slides, t1;
  slides = $.Slides$();
  slides.start$1(slides, $.get$hash$x($.Window_methods.get$location(window)));
  t1 = $.Window_methods.get$onKeyDown(window);
  $._EventStreamSubscription$(t1._target, t1._eventType, new $.main_closure(slides), t1._useCapture);
};

$.Slides$ = function() {
  return new $.Slides(null, null, null, null, null, null, null);
};
...
$.List_k6U = Isolate.makeConstantList(["distant-slide", "far-past", "past", "current", "future", "far-future", "distant-slide"]);
...
$.set$backgroundSize$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$backgroundSize(receiver, value);
};
$.set$borderRadius$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$borderRadius(receiver, value);
};
$.set$boxReflect$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$boxReflect(receiver, value);
};
$.set$boxShadow$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$boxShadow(receiver, value);
};
$.set$color$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$color(receiver, value);
};
$.set$columnCount$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$columnCount(receiver, value);
};
...
$.set$textShadow$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$textShadow(receiver, value);
};
$.set$textStrokeWidth$x = function(receiver, value) {
  return $.getInterceptor$x(receiver).set$textStrokeWidth(receiver, value);
};
...
//@ sourceMappingURL=slides.dart.js.map
